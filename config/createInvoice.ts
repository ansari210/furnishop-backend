...
function invoiceHeader(doc: PDFKit.PDFDocument) {
  doc
    ...
    .fontSize(10)
    .text("Bedsdivans", 200, 50, { align: "right" })
    .text("123 Main Street", 200, 65, { align: "right" })
    .text("New York, NY, 10025", 200, 80, { align: "right" })
    .moveDown();
}

function invoiceCustomerInformation(doc: PDFKit.PDFDocument, invoice: Invoice) {
...
function invoiceTable(doc: PDFKit.PDFDocument, invoice: Invoice) {
  let i;
...
function invoiceFooter(doc: PDFKit.PDFDocument) {
  doc
    .fontSize(10)
    .text(
